    ...
    getStringParam(ADnEDHdfFilePathParam, sizeof(hdfFilePath), hdfFilePath);
        ...
        switch(hdfFileWriteMode){
              ...
              case 1:
                ...
                sprintf(single_hdf_file_name_UI,"%.4s%.2s%.2s%.2s%.2s%.2s%.3s",mFileName_year,mFileName_month,mFileName_day,mFileName_hour,mFileName_min,mFileName_second,".h5");
                cout<<"the current file name is < "<<single_hdf_file_name<<" > "<<endl;
                setStringParam(ADnEDHdfFullFileNameParam, single_hdf_file_name_UI);  
